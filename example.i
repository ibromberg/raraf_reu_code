...
30 wed 50 50 40 0 -10 0 0 0 -17.32 10 0 0       $ wedge of W
c 40 sq 1 1 1 0 0 0 -0.16 55 1 70                  $ representing source
...
c  - SOURCES -
sdef pos=55 0 30 axs=0 1 0 ext=0 rad=d1 par=3 erg=0.05 vec=0 1 0 dir=1  
si1 0 0.4                             $ radial sample from 0 to rmax=4mm=0.4cm
sp1 -21 1                             $ radial sample weighting
c  - TALLYING -
*f1:p 20.5 20.6   $ photon tally top of box and bottom of box
E1 0.001 99i 0.01   $ tally energy
print 110
prdmp 2j 1
nps 1e7
